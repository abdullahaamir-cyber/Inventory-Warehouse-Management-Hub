...
int ConsoleUI::showMenu(const string& menuTitle, const vector<string>& options) 
{
    clearScreen();
...
void ConsoleUI::printTable(const vector<string>& headers, const vector<int>& widths, const vector<vector<string>>& rows) 
{
